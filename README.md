闲置电视盒子别只拿来吃灰，Selene-TV 可以把它重新变成一台适合大屏观影的开源客户端。

它专为电视和遥控器设计，支持：

1. 聚合搜索电影、剧集、动漫与直播，动漫还能查看 Bangumi 周表
2. 详情页采用大幅 Hero 视觉与 TMDB 剧照，整体更贴近客厅大屏体验
3. 手机扫码后可充当遥控器和输入法，解决电视端输入麻烦
4. 基于 ExoPlayer，兼容 HLS、MP4，也支持自签名证书

使用 Kotlin + Compose for TV 构建，Android 6.0 及以上可用。自己搭影视库的话，可以把它作为电视端入口。
